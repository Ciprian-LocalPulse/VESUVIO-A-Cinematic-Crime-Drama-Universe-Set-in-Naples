...
- A **production partner or studio** to attach a showrunner/director and
  move the pilot into development.
- **Development financing** to complete a full production-ready pilot
  script and expanded story bible.
- **Streaming or broadcast partners** interested in regional-language
  premium crime drama.
...
- An authentic, culturally specific setting (Naples, Neapolitan dialect)
  with strong genre precedent for international streaming success.
- A creator with a clear, complete, multi-season vision for the property
  from day one.

...
- Lens family: spherical primes with gentle, characterful rendering
  rather than clinical modern sharpness — supports the grounded,
  naturalistic tone.
...
- **Exteriors / institutional scenes (police, court, port business):**
  locked-off or slow, controlled dolly moves — visually separating the
  family's private volatility from its public composure.
- **Vesuvius establishing shots:** always static, wide, symmetrical —

# Lore & Extended Background

This document expands on background material referenced but not fully
detailed in the [Story Bible](docs/story_bible/Story_Bible.md). Unlike
[`CANON.md`](CANON.md), material here is explorative and may evolve as
...
involved. Part of what makes the Peace so fragile in Season 1 is that
almost none of it was ever formally written down; it survives only in
memory and reputation, carried by a generation that is now aging out of
power.
...
identity that exists somewhat independently of the Camorra's presence,
even as it's shaped by it. Future scripts should treat rione residents
as a community with its own interior life, not merely a backdrop for
family business.
...
future episodes can use church settings as low-violence, high-tension
scene opportunities.
...
extinct status. Any future depiction should preserve this restraint;
avoid personifying or mythologizing the mountain beyond its established
...
- The extent of Judge Conte's original debt to the Ranieri family is
  deliberately unresolved pending writers'-room development.
- Elena Ferraro's prior case history (hinted at in her character bible)
  is open territory for a future season's backstory episode.

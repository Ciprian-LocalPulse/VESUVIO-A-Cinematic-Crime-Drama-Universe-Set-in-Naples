...
established from the start were:

- **Setting:** Naples, in the shadow of Mount Vesuvius — a city split
  between beauty and danger, tradition and violence.
- **Themes:** Loyalty, betrayal, power, and honor within a modern
  organized-crime structure.
- **Tone:** Cinematic, dark, grounded — closer to prestige crime drama than
...
recurring dynamic in the story — two voices, two perspectives, one code of
honor. Production leans into **dark melodic trap**: sub-bass, distorted
bells, industrial percussion, and a hard tonal "drop" after the chorus,
designed to work equally well as a title-sequence theme or a needle-drop
inside key episodes.

See [`docs/LYRICS_BILINGUAL.md`](./LYRICS_BILINGUAL.md) for the full
lyric sheet with English translation, and
[`assets/track_final.mp3`](../assets/track_final.mp3) for the finished
track.
...
simmering violence beneath the show's surface. Supporting elements
(falling feathers, distressed typography, a muted gold/black palette)
...
AI tools were used to accelerate execution (audio production, image
generation) of a fully human-authored concept. The prompt logic used to
guide generation is documented in
[`prompts/generation_rules.txt`](../prompts/generation_rules.txt) for
...
and extended music package are the next planned deliverables.

---
© 2026 Ciprian Stefan Plesca. See [`LICENSE`](../LICENSE) for usage terms.
